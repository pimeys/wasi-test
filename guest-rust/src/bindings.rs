...
// Options used:
pub type Headers = component::hello::types::Headers;
pub type ErrorResponse = component::hello::types::ErrorResponse;
#[doc(hidden)]
#[allow(non_snake_case)]
pub unsafe fn _export_request_callback_cabi<T: Guest>(arg0: i32) -> *mut u8 {
    #[cfg(target_arch = "wasm32")]
    _rt::run_ctors_once();
    let result0 = T::request_callback(component::hello::types::Headers::from_handle(arg0 as u32));
    ...
    match result0 {
        ...
        Err(e) => {
            *ptr1.add(0).cast::<u8>() = (1i32) as u8;
            let component::hello::types::ErrorResponse {
                status: status2,
                message: message2,
            } = e;
            match status2 {
...
#[doc(hidden)]
#[allow(non_snake_case)]
pub unsafe fn __post_return_request_callback<T: Guest>(arg0: *mut u8) {
...
macro_rules! __export_world_example_cabi{
  ($ty:ident with_types_in $($path_to_types:tt)*) => (const _: () = {
    ...
    #[export_name = "request-callback"]
    unsafe extern "C" fn export_request_callback(arg0: i32,) -> *mut u8 {
      $($path_to_types)*::_export_request_callback_cabi::<$ty>(arg0)
    }
    #[export_name = "cabi_post_request-callback"]
    unsafe extern "C" fn _post_return_request_callback(arg0: *mut u8,) {
      $($path_to_types)*::__post_return_request_callback::<$ty>(arg0)
    }
  };);
}
#[doc(hidden)]
        ...
        pub mod types {
            ...
            unsafe impl _rt::WasmResource for Headers {
                ...
                unsafe fn drop(_handle: u32) {
                    ...
                    #[cfg(target_arch = "wasm32")]
                    {
                        #[link(wasm_import_module = "component:hello/types")]
                        extern "C" {
...
A\x0a\x01B\x0a\x04\0\x07headers\x03\x01\x01k{\x01r\x02\x06status\x01\x07messages\
\x04\0\x0eerror-response\x03\0\x02\x01h\0\x01ks\x01@\x02\x04self\x04\x04names\0\x05\
\x04\0\x13[method]headers.get\x01\x06\x01@\x03\x04self\x04\x04names\x05values\x01\
\0\x04\0\x13[method]headers.set\x01\x07\x03\x01\x15component:hello/types\x05\0\x02\
\x03\0\0\x07headers\x03\0\x07headers\x03\0\x01\x02\x03\0\0\x0eerror-response\x03\
\0\x0eerror-response\x03\0\x03\x01i\x02\x01j\0\x01\x04\x01@\x01\x07headers\x05\0\
\x06\x04\0\x10request-callback\x01\x07\x04\x01\x17component:hello/example\x04\0\x0b\
