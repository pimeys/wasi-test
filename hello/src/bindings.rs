...
pub unsafe fn _export_hello_world_cabi<T: Guest>(arg0: *mut u8, arg1: usize) -> *mut u8 {
...
macro_rules! __export_world_example_cabi{
  ($ty:ident with_types_in $($path_to_types:tt)*) => (const _: () = {
    ...
    unsafe extern "C" fn export_hello_world(arg0: *mut u8,arg1: usize,) -> *mut u8 {
      $($path_to_types)*::_export_hello_world_cabi::<$ty>(arg0, arg1)
    }
...
@\x01\x04names\0s\x04\0\x0bhello-world\x01\0\x04\x01\x17component:hello/example\x04\
